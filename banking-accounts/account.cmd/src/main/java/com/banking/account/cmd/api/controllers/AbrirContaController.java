...
public class AbrirContaController {
    private final Logger logger = Logger.getLogger(AbrirContaController.class.getName());

    @Autowired
    private CommandDispatcher commonDispatcher;

    @PostMapping
    public ResponseEntity<BaseResponse> openAccount(@RequestBody AbrirContaCommand command){
